...
enum RBACPermissions
{
    ...
    RBAC_FPERM_COMMAND_CUSTOMNPC_CREATE                      = 2101,
    RBAC_FPERM_COMMAND_CUSTOMNPC_SPAWN                       = 2102,
    RBAC_FPERM_COMMAND_CUSTOMNPC_SET_DISPLAYNAME             = 2103,
    RBAC_FPERM_COMMAND_CUSTOMNPC_SET_FACE                    = 2104,
    RBAC_FPERM_COMMAND_CUSTOMNPC_SET_GENDER                  = 2105,
    RBAC_FPERM_COMMAND_CUSTOMNPC_SET_RACE                    = 2106,
    RBAC_FPERM_COMMAND_CUSTOMNPC_SET_SUBNAME                 = 2107,
    RBAC_FPERM_COMMAND_CUSTOMNPC_EQUIP_ARMOR                 = 2108,
    RBAC_FPERM_COMMAND_CUSTOMNPC_EQUIP_LEFT                  = 2109,
    RBAC_FPERM_COMMAND_CUSTOMNPC_EQUIP_RANGED                = 2110,
    RBAC_FPERM_COMMAND_CUSTOMNPC_EQUIP_RIGHT                 = 2111,
    RBAC_FPERM_COMMAND_CUSTOMNPC_DELETE                      = 2112,
    RBAC_FPERM_COMMAND_CUSTOMNPC_UNEQUIP_ARMOR               = 2113,
    RBAC_FPERM_COMMAND_CUSTOMNPC_UNEQUIP_LEFT                = 2114,
    RBAC_FPERM_COMMAND_CUSTOMNPC_UNEQUIP_RANGED              = 2115,
    RBAC_FPERM_COMMAND_CUSTOMNPC_UNEQUIP_RIGHT               = 2116,
    // custom permissions 1000+
