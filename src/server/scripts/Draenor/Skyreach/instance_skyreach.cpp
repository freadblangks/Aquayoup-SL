    ...
    struct instance_skyreachInstanceMapScript : public InstanceScript
    {
        ...
        bool SetBossState(uint32 p_ID, EncounterState p_State)
        {
            ...
            case Data::Ranjit:
            {
                ...
                {
                    DoCompleteAchievement2(uint32(Achievements::ReadyForRaidingIV));
                }
            ...
            case Data::Araknath:
            {
                ...
                case EncounterState::DONE:
                {
                    if (instance->IsHeroic())
                        DoCompleteAchievement2(uint32(Achievements::MagnifyEnhance));
            ...
            case Data::Rukhran:
            {
                ...
                case EncounterState::FAIL:
                {
                    ...
                    {
                        l_Rukhran->GetMotionMaster()->Clear();
            ...
            case Data::HighSageViryx:
            {
                ...
                case EncounterState::DONE:
                {
                    ...
                    if (instance->IsHeroic())
                        DoCompleteAchievement2(uint32(Achievements::HeroicSkyreach));
                    else
                        DoCompleteAchievement2(uint32(Achievements::Skyreach));

                    if (instance->IsHeroic() && !m_HasFailedMonomaniaAchievement)
                        DoCompleteAchievement2(uint32(Achievements::Monomania));
            ...
            case Data::SolarFlareDying:
                ...
                if (Unit* l_SolarFlareDying = instance->GetCreature(p_Data))
                {
                    ...
                    if (l_SolarFlaresFormed >= 3)
                        DoCompleteAchievement2(uint32(Achievements::ISawSolis));
                    ...
                    l_SolarFlareDying->Kill2(l_SolarFlareDying);
