    ...
    public:
        ...
        struct boss_flamebender_kagrazAI : public BossAI
        {
            ...
            void JustDied(Unit* /*p_Killer*/) override
            {
                ...
                me->DespawnCreaturesInArea2(eFoundryCreatures::CinderWolf, 200.0f);
                me->DespawnCreaturesInArea2(eCreatures::OverheatedCinderWolf, 200.0f);
                    ...
                    case eSpells::LavaSlashMissileTriggered:
                    {
                       ...
                       // {
                            ...
                            for (uint8 l_I = 0; l_I < l_Dist; ++l_I)
                            {
                                ...
                                float l_O = l_Src->GetAngle2(l_Dest);
        ...
        struct npc_foundry_cinder_wolfAI : public ScriptedAI
        {
            ...
            void UpdateAI(uint32 p_Diff) override
            {
               // UpdateOperations(p_Diff);
                ...
                {
                    if (Unit* l_Target = SelectTarget(SelectAggroTarget::SELECT_TARGET_MAXTHREAT))
                        me->SetFacingTo(me->GetAngle2(l_Target));
