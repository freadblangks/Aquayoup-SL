...
class gob_mark_of_tanaan : public PlayerScript
{
public:
    gob_mark_of_tanaan() : PlayerScript("gob_mark_of_tanaan") { }
...
/// 233104 - Statis Rune
class gob_static_rune : public PlayerScript
{
public:
    gob_static_rune() : PlayerScript("gob_static_rune") { }
