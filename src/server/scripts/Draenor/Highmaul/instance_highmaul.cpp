                        ...
                        switch (state)
                        {
                            ...
                            case EncounterState::DONE:
                            {
                             ...
                             //   if (!instance->IsLFR() && m_KargathAchievement)
                                    DoCompleteAchievement2(eHighmaulAchievements::FlameOn);
                    ...
                    case eHighmaulDatas::BossTheButcher:
                    {
                        switch (state)
                        {
                            ...
                            //    if (!instance->IsLFR() && m_MaggotKilled >= eHighmaulDatas::MaxMaggotToKill)
                                    DoCompleteAchievement2(eHighmaulAchievements::HurryUpMaggot);
                        ...
                        switch (state)
                        {
                            ...
                            case EncounterState::DONE:
                            {
                               // if (!instance->IsLFR() && m_TectusAchievement)
                                    DoCompleteAchievement2(eHighmaulAchievements::MoreLikeWreckedUs);
                        ...
                        switch (state)
                        {
                            ...
                            case EncounterState::DONE:
                            {
                               // if (!instance->IsLFR() && m_BrackensporeAchievement)
                                    DoCompleteAchievement2(eHighmaulAchievements::AFungusAmongUs);
                        ...
                        switch (state)
                        {
                            ...
                            case EncounterState::DONE:
                            {
                              //  if (!instance->IsLFR() && m_TwinOgronAchievement)
                                    DoCompleteAchievement2(eHighmaulAchievements::BrothersInArms);
                        ...
                        switch (state)
                        {
                            ...
                            case EncounterState::DONE:
                            {
                             //   if (!instance->IsLFR() && m_NullificationBarrier && m_OverflowingEnergies < eHighmaulDatas::MaxOverflowingEnergy)
                                    DoCompleteAchievement2(eHighmaulAchievements::PairAnnihilation);
                        ...
                        switch (state)
                        {
                            ...
                            case EncounterState::DONE:
                            {
                              //  if (!instance->IsLFR() && m_ImperatorAchievement)
                                    DoCompleteAchievement2(eHighmaulAchievements::LineageOfPower);

                                if (instance->IsMythic())
                                {
                                    DoCompleteAchievement2(eHighmaulAchievements::AheadOfTheCurve);
                                    DoCompleteAchievement2(eHighmaulAchievements::CuttingEdge);
                                }
