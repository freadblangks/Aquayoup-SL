            ...
            void UpdateAI(uint32 const diff) override
            {
                ...
                switch (m_Events.ExecuteEvent())
                {
                    ...
                    case eEvents::EventEarthdevastatingSlam:
                    {
                        ...
                        {
                            m_orientation = me->GetAngle2(target);
                            m_SlamCount = 0;
                            me->SetFacingTo(m_orientation);
...
class go_highmaul_arena_elevator : public PlayerScript
{
    public:
        go_highmaul_arena_elevator() : PlayerScript("go_highmaul_arena_elevator") { }
