...
/// 232552
class go_everbloom_entrance_portal : public PlayerScript
{
public:
    go_everbloom_entrance_portal() : PlayerScript("go_everbloom_entrance_portal")
    {
        checkTimer = 1000;
    }
...
/// 234025 / 234121
class go_everbloom_stormwind_portal : public PlayerScript
{
public:
    go_everbloom_stormwind_portal() : PlayerScript("go_everbloom_stormwind_portal")
    {
        checkTimer = 1000;
    }
