...
class xeri_tac_vehicle : public PlayerScript
{
public:
    xeri_tac_vehicle() : PlayerScript("xeri_tac_vehicle") { }
...
// Toxic Eggs - 234113
class toxic_eggs_go : public PlayerScript
{
public:
    toxic_eggs_go() : PlayerScript("toxic_eggs_go") { }
