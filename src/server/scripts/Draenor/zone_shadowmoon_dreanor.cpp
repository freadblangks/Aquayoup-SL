...
class npc_baros_pre_garrison : public PlayerScript
{
public:
    npc_baros_pre_garrison() : PlayerScript("npc_baros_pre_garrison") { }
...
// 85645 - Gara
class npc_gara : public PlayerScript
{
public:
    npc_gara() : PlayerScript("npc_gara") { }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        if(player->GetQuestStatus(37423) != QUEST_STATUS_INCOMPLETE && player->GetQuestStatus(37423) != QUEST_STATUS_COMPLETE && player->GetQuestStatus(37423) != QUEST_STATUS_REWARDED)
            AddGossipItemFor(player, GossipOptionIcon::None, "(Beast Mastery) Lean down and scratch the wolf behind its ears.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        ...
        if (player->GetQuestStatus(37423) == QUEST_STATUS_REWARDED && player->GetQuestStatus(37424) != QUEST_STATUS_REWARDED && player->HasItemCount(ITEM_SHADOWBERRY, 1))
            AddGossipItemFor(player, GossipOptionIcon::None, "(Beast Mastery) Show Gara the Shadowberries.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    ...
    {
        if (player->getClass() != CLASS_HUNTER || player->GetSpecializationId2() != TALENT_SPEC_HUNTER_BEASTMASTER)
            return false;
...
class go_shadowmoon_voidblade : public PlayerScript
{
public:
    go_shadowmoon_voidblade() : PlayerScript("go_shadowmoon_voidblade") { }
