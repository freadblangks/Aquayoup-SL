...
struct boss_king_gobbamak : public BossAI
{
    ...
    void JustDied(Unit* killer) override
    {
        _JustDied();
        Talk(SAY_DEATH);
        me->DespawnCreaturesInArea2(NPC_STOLEN_SCRAPBOT, 125.0f);
        me->DespawnCreaturesInArea2(NPC_STOLEN_SHOCK_COIL, 125.0f);
        me->DespawnCreaturesInArea2(NPC_SCRAPBONE_GRUNTER, 125.0f);
    ...
    void JustReachedHome() override
    {
        ...
        me->DespawnCreaturesInArea2(NPC_SCRAPBONE_GRUNTER);
