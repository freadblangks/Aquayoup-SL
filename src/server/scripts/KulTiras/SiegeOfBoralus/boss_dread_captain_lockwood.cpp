...
struct boss_dread_captain_lockwood : public BossAI
{
	...
	void Reset() override
	{
		...
		me->DespawnCreaturesInArea2(NPC_ASHVANE_DECKHAND, 125.0f);
		me->DespawnCreaturesInArea2(NPC_ASHAVANE_CANNONNEER, 125.0f);
		me->DespawnCreaturesInArea2(NPC_CANNON_BARRAGE, 125.0f);
		Talk(SAY_WIPE);
