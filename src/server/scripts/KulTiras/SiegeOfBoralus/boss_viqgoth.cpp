			...
			{				
				...
				{					
					...
					{	
						...
						viqgoth->DespawnCreaturesInArea2(NPC_DEMOLISHING_TERROR);
						viqgoth->DespawnCreaturesInArea2(NPC_GRIPPING_TERROR);
						viqgoth->DespawnCreaturesInArea2(NPC_CANNON_VIQ_ENCOUNTER);						
