...
public:
    ...
    bool OnGossipHello(Player* player, Creature* me)
    {
        ...
        AddGossipItemFor(player, GossipOptionIcon::None, "Show me the abomination.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    ...
    bool OnGossipSelect(Player* pPlayer, Creature* pCreature, uint32 /*sender*/, uint32 action)
    {
        ...
        {
            pPlayer->TeleportTo2(1841, 1221.52f, 1525.49f, -181.81f, 4.39f, 0,0);
