...
class npc_whack_gnoll_mola : public PlayerScript
{
    public:
        npc_whack_gnoll_mola() : PlayerScript("npc_whack_gnoll_mola") { }
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if (player->GetQuestStatus(QUEST_WHACK_A_GNOLL) == QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player, GossipOptionIcon::None, "Je souhaite jouer a Cogne-Gnoll !", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
