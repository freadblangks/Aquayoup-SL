...
class npc_canon_maxima : public PlayerScript
{
    public:
        npc_canon_maxima() : PlayerScript("npc_canon_maxima") { }
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if (player->GetQuestStatus(QUEST_HUMANOID_CANNONBALL) == QUEST_STATUS_INCOMPLETE)
                AddGossipItemFor(player, GossipOptionIcon::None, "Je souhaite devenir un homme canon !", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
class npc_canon_fozlebub : public PlayerScript
{
    public:
        npc_canon_fozlebub() : PlayerScript("npc_canon_fozlebub") { }
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            if (player->GetQuestStatus(QUEST_HUMANOID_CANNONBALL) != QUEST_STATUS_NONE)
                AddGossipItemFor(player, GossipOptionIcon::None, "Teleportez moi au canon !", GOSSIP_SENDER_MAIN, 0, "Souhaitez-vous payer 30 piece d'argent ?", 3000, false);
