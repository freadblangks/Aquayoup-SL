...
struct boss_drestagath : public BossAI
{
	...
	{
		_JustReachedHome();
		me->DespawnCreaturesInArea2(NPC_EYE_OF_DRESTAGATH, 125.0f);
		me->DespawnCreaturesInArea2(NPC_TENTACLE_OF_DRESTAGATH, 125.0f);
		me->DespawnCreaturesInArea2(NPC_MAW_OF_DRESTAGATH, 125.0f);
