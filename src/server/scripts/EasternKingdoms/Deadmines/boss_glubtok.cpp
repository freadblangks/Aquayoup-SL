...
#define MAX_FirewallPlatterCyclicPathSize 9
Position const FirewallPlatterCyclicPath[MAX_FirewallPlatterCyclicPathSize] =
{
...
struct boss_glubtok : public BossAI
{
    ...
    void JustAppeared() override
    {
        ...
        {
           platter->GetMotionMaster()->MoveCirclePath(FirewallPlatterCyclicPath[1].GetPositionX(), FirewallPlatterCyclicPath[1].GetPositionY(), 54.57029f, 1.833041f, false, 0.25f);
        }
    }
