...
struct at_shattered_soul_fragment : AreaTriggerAI
{
    ...
    void OnUnitEnter(Unit* unit) override
    {
        ...
        {
        case 10665:
            if (at->GetCaster()->ToPlayer()->GetSpecializationId2() == TALENT_SPEC_DEMON_HUNTER_HAVOC)
...
public:
    ...
    public:
        ...
        void Proc(ProcEventInfo& eventInfo)
        {
            ...
            if (caster->GetSpecializationId2() == TALENT_SPEC_DEMON_HUNTER_HAVOC)
                caster->EnergizeBySpell(caster, GetSpellInfo(), pointsGained, POWER_FURY);
            else if (caster->GetSpecializationId2() == TALENT_SPEC_DEMON_HUNTER_VENGEANCE)
...
public:
    ...
    class spell_dh_last_resort_AuraScript : public AuraScript
    {
        ...
        void HandleAbsorb(AuraEffect* /*aurEff*/, DamageInfo& dmgInfo, uint32& absorbAmount)
        {
            ...
            int32 healthPct = GetSpellInfo()->GetEffect(EFFECT_1).BasePoints;
            target->SetHealth(1);
...
public:
    ...
    class spell_dh_bloodlet_AuraScript : public AuraScript
    {
        ...
        void HandleEffectProc(AuraEffect* aurEff, ProcEventInfo& eventInfo)
        {
            ...
            GetSpellInfo()->GetEffect(EFFECT_0);
                return;
...
public:
    ...
    class spell_dh_awaken_the_demon_AuraScript : public AuraScript
    {
        ...
        void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
        {
            ...
            //nt32 caster = GetSpellInfo()->GetEffect(EFFECT_1);
            //int32 caster = GetSpellInfo()->GetEffect(EFFECT_2);
                //return;
...
public:
    ...
    class spell_dh_solitude_AuraScript : public AuraScript
    {
        ...
        void HandlePeriodic(AuraEffect const* /*aurEff*/)
        {
            ...
            Unit* caster = GetCaster();
            if (!caster)
                GetSpellInfo()->GetEffect(EFFECT_1);
                return;
