...
class npc_expedition_map : public PlayerScript
{
public:
    npc_expedition_map() : PlayerScript("npc_expedition_map") { }
...
class go_pouch_of_azerite : public PlayerScript
{
public:
    go_pouch_of_azerite() : PlayerScript("go_pouch_of_azerite") { }
...
class go_azerite_crystal : public PlayerScript
{
public:
    go_azerite_crystal() : PlayerScript("go_azerite_crystal") { }
