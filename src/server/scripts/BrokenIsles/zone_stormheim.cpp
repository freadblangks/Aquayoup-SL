...
class go_volatile_barrel_stormheim : public PlayerScript
{
public:
    go_volatile_barrel_stormheim() : PlayerScript("go_volatile_barrel_stormheim") { }
...
class npc_grapple_point : public PlayerScript
{
public:
    npc_grapple_point() : PlayerScript("npc_grapple_point") { }
...
class go_powered_console_stormheim_243802 : public PlayerScript
{
public:
    go_powered_console_stormheim_243802() : PlayerScript("go_powered_console_stormheim_243802") { }
    bool OnGossipHello(Player* player, GameObject* go)
    {
...
//243817
class go_powered_console_stormheim_243817 : public PlayerScript
{
public:
    go_powered_console_stormheim_243817() : PlayerScript("go_powered_console_stormheim_243817") { }
    bool OnGossipHello(Player* player, GameObject* go)
    {
...
class go_tideskorn_harpoon_launcher_251257 : public PlayerScript
{
public:
    go_tideskorn_harpoon_launcher_251257() : PlayerScript("go_tideskorn_harpoon_launcher_251257") { }
...
class go_rune_of_reformation_244450 : public PlayerScript
{
public:
    go_rune_of_reformation_244450() : PlayerScript("go_rune_of_reformation_244450") { }
...
class go_helyas_altar_244559 : public PlayerScript
{
public:
    go_helyas_altar_244559() : PlayerScript("go_helyas_altar_244559") { }
...
class go_engraved_shield_quest_38878 : public PlayerScript
{
public:
    go_engraved_shield_quest_38878() : PlayerScript("go_engraved_shield_quest_38878") { }
