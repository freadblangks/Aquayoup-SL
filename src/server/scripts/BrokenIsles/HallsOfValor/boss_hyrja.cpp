...
class boss_hyrja : public PlayerScript
{
public:

    boss_hyrja() : PlayerScript("boss_hyrja") { }
...
class npc_olmyr_the_enlightened : public PlayerScript
{
public:

    npc_olmyr_the_enlightened() : PlayerScript("npc_olmyr_the_enlightened") { }
...
class npc_olmyr_ghost : public PlayerScript
{
public:

    npc_olmyr_ghost() : PlayerScript("npc_olmyr_ghost") { }
...
class npc_solsten : public PlayerScript
{
public:

    npc_solsten() : PlayerScript("npc_solsten") { }
...
class npc_solsten_ghost : public PlayerScript
{
public:

    npc_solsten_ghost() : PlayerScript("npc_solsten_ghost") { }
