...
class npc_field_of_eternal_hunt : public PlayerScript
{
public:
    npc_field_of_eternal_hunt() : PlayerScript("npc_field_of_eternal_hunt") { }
...
class npc_halls_of_valor : public PlayerScript
{
public:
    npc_halls_of_valor() : PlayerScript("npc_halls_of_valor") { }
