    ...
    void DoAction(int32 param) override
    {
        ...
        case EVENT_INTRO:
            ...
            if (Creature* drelanim = me->FindNearestCreature(NPC_DRELANIM_WHISPERWIND, 100.0f, true))
            {
                ...
                instance->DoPlayConversation(866);
                instance->DoPlayConversation(867);
                instance->DoPlayConversation(868);
                instance->DoPlayConversation(869);
                instance->DoPlayConversation(870);
                instance->DoPlayConversation(871);
                instance->DoPlayConversation(872);
                instance->DoPlayConversation(873);
