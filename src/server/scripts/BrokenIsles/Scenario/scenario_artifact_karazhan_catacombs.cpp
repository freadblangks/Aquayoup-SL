...
struct scenario_artifact_karazhan_catacombs : public InstanceScript
{
    ...
    void SetData(uint32 type, uint32 data) override
    {
        ...
        {
            NextStep();
            MovieEntry(DRUID_BALANCE_ACQUISTION_ARTIFACT_LOOTED_SCENE);
            SendBossKillCredit(103748);
        }
...
struct npc_the_conservator_101257 : public ScriptedAI
{
    ...
    void DoAction(int32 param) override
    {
        ...
        case 1:
            me->Yell(103603);
            me->GetMotionMaster()->MovePoint(1, me->GetPositionWithOffset(15.0f), true);
            break;
        case 2:
            islow = true;
            EventMap().CancelEvent(SPELL_HATEFUL_BOLT);
            EventMap().ScheduleEvent(SPELL_EVOCATION, 2 * IN_MILLISECONDS);
            break;
        }
    }
    ...
    {
        EventMap().ScheduleEvent(SPELL_HATEFUL_BOLT, 2 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        while (uint32 eventId = EventMap().ExecuteEvent())
        {
            ...
            case SPELL_EVOCATION:
            {
                ...
                EventMap().ScheduleEvent(SPELL_EVOCATION, 10 * IN_MILLISECONDS);
                break;
            }
            default:
                break;
...
class go_the_scythe_of_elune_1 : public PlayerScript
{
public:
    go_the_scythe_of_elune_1() : PlayerScript("go_the_scythe_of_elune_1") { isloot = false; }
...
struct npc_ariden_100850 : public ScriptedAI
{
    ...
    void DoAction(int32 param) override
    {
        ...
        case ACTION_STAGE_2:
        {
            ...
            me->FindNearestCreature(100845, 50.0f);
        ...
        case ACTION_STAGE_4:
        {
            ...
            me->GetScheduler().Schedule(Milliseconds(6000), [](TaskContext context)
            {
                ...
                GetContextCreature()->GetMotionMaster()->MoveTakeoff(40.0f, 5000);
...
struct npc_ariden_102200 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* victim)
    {
        ...
        EventMap().ScheduleEvent(SPELL_PHANTOM_SCYTHE, 2 * IN_MILLISECONDS);
        EventMap().ScheduleEvent(SPELL_BLOODREAP, 10 * IN_MILLISECONDS);
        EventMap().ScheduleEvent(SPELL_EXHAUSTION, 25 * IN_MILLISECONDS);
    }
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        while (uint32 eventId = EventMap().ExecuteEvent())
        {
            ...
            case SPELL_PHANTOM_SCYTHE:
            {
                ...
                EventMap().ScheduleEvent(SPELL_PHANTOM_SCYTHE, 10 * IN_MILLISECONDS);
                break;
            }
...
class go_the_scythe_of_elune_246437 : public PlayerScript
{
public:
    go_the_scythe_of_elune_246437() : PlayerScript("go_the_scythe_of_elune_246437") { isloot = false; }
