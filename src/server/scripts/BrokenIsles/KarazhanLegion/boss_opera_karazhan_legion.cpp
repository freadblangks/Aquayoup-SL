...
class npc_kara_barnes : public CreatureScript
{
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            AddGossipItemFor(player, GossipOptionIcon::None, "I'm not a actor", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
            ...
            void DamageTaken(Unit* owner, uint32 & damage) override
            {
                ...
                if (galindre)
                {
                    if (owner->GetEntry() != BOSS_GALINDRE)
                        me->DealDamage(galindre , owner, true);
                }
            }
            ...
            void DamageTaken(Unit* owner, uint32 & damage) override
            {
                ...
                if (elfyra)
                {
                    if (owner->GetEntry() != BOSS_ELFYRA)
                        me->DealDamage(elfyra, owner, true);
                }
            }
