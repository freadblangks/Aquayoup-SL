...
class npc_kara_image_of_medivh : public CreatureScript
{
    public:
        ...
        bool OnGossipHello(Player* player, Creature* creature)
        {
            ...
            AddGossipItemFor(player, GossipOptionIcon::None, "Summon Nightbane", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
class go_door_entrance : public PlayerScript
{
    public:
        go_door_entrance() : PlayerScript("go_door_entrance") { }
