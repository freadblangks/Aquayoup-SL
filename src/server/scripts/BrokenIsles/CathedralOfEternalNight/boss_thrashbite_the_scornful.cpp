...
struct boss_thrashbite_the_scornful : public BossAI
{
    ...
    void Initialize()
    {
        ...
        Talk(EVENT_ON_ENTERCOMBAT);
        Talk(EVENT_ON_JUSTDIED);
    }
...
struct npc_gazerax_118723 : public ScriptedAI
{
    ...
    {
        EventMap().ScheduleEvent(SPELL_BLINDING_GLARE, 5000);
        EventMap().ScheduleEvent(SPELL_FEL_GLARE, 5000);
        EventMap().ScheduleEvent(SPELL_FOCUSED_DESTRUCTION, 5000);
    }
