...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        AddGossipItemFor(player, GossipOptionIcon::None, "I will fight her in your name, Odyn!", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
public:
    ...
    class spell_odyn_draw_power_AuraScript : public AuraScript
    {
        ...
        {
            GetCaster()->EnergizeBySpell(GetCaster(), GetSpellInfo(), flag ? 3 : 4, POWER_ENERGY);
            flag = !flag;
        }
