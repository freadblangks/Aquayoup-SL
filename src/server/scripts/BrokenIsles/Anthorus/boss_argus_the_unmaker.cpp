...
struct boss_argus_the_unmaker : public BossAI
{
    ...
    void Initialize()
    {
        //EventMap().SetDungeonEncounterID(2092);
    ...
    void JustDied(Unit* /*killer*/) override
    {
        ...
        if (IsMythic())
        {
            instance->DoCompleteAchievement2(12002);
            me->GetVirtualItemId(152789); // loot shackled-urzul
        }

        instance->DoCompleteAchievement2(11991);
        instance->DoCompleteAchievement2(12266);
        if (IsMythic() || IsHeroic())
            me->GetVirtualItemId(152900); // loot blood-of-the-unmaker
        instance->AddTimedDelayedOperation(5000, [this]() -> void
        {
            me->PlayDirectMusic(688);
        });
    ...
    void SwitchPhase(uint32 phase)
    {
        ...
        case PHASE_03:
            ...
            AddTimedDelayedOperation(10000, [this]() -> void
            {
                ...
                PhasingHandler::AddPhase(me, 170, true);
            });
            break;
        case PHASE_04:
            //phase4
            ...
            me->NearTeleportTo(Position(2887.892f, -4567.8f, 291.965f, 3.09f));
            ...
            AddTimedDelayedOperation(20000, [this]() -> void
            {
                ...
                me->CastSpell(SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION, true);//instance->DoResurrectPlayers(1.0f);
            });
    ...
    {
        if (me->HealthBelowPctDamaged(HP_70, damage))
...
struct npc_constellar_designate_127192 : public ScriptedAI
{
    ...
    {
        EventMap().ScheduleEvent(SPELL_STARBLAST, 8s);
        if (!IsMythic())
        EventMap().ScheduleEvent(SPELL_COSMIC_RAY, 30s);
        EventMap().ScheduleEvent(SPELL_COSMIC_BEACON, 40s);
    }
...
struct npc_reorigination_module_127809 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/)
    {
        EventMap().ScheduleEvent(SPELL_INITIALIZATION_SEQUENCE, 8s);
        EventMap().ScheduleEvent(SPELL_REORIGINATION_MODULE_DMG, 45s);
    }
