...
enum Talk
{
    ...
    SPELL_REVERBERATING_STRIKE2 = 1,
    SPELL_RUINER2 = 2,
    SPELL_APOCALYPSE_PROTOCOL2 = 3,
    SPELL_APOCALYPSE_PROTOCOL3 = 4,
    SPELL_PURGING_PROTOCOL2 = 5,
    EVENT_ON_JUSTDIED = 14
};
///.go creature id
struct boss_kingaroth : public BossAI
{
    ...
    void ExecuteEvent(uint32 eventId) override
    {
        ...
        case SPELL_APOCALYPSE_PROTOCOL:
        {
            ...
            if (wave > EVENT_3)
                wave = EVENT_1;
            Talk(SPELL_APOCALYPSE_PROTOCOL2);
        ...
        {
            Talk(SPELL_REVERBERATING_STRIKE2);
...
struct npc_garothi_kingaroth_mobs : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*attacker*/)
    {
        ...
        {
        case NPC_GAROTHI_ANNIHILATOR:
            EventMap().ScheduleEvent(SPELL_ANNIHILATION, 16s);
            break;
        case NPC_GAROTHI_DECIMATOR:
            EventMap().ScheduleEvent(SPELL_DECIMATION, 11s);
            break;
        case NPC_GAROTHI_DEMOLISHER:
            EventMap().ScheduleEvent(SPELL_DEMOLISH, 16s);
            break;
        default:
            break;
        }
        EventMap().ScheduleEvent(SPELL_INITIALIZING, 30s);
    }
