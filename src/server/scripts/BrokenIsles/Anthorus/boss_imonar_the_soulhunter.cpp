...
enum Talk
{
    ...
    SPELL_SLEEP_CANISTER2 = 2,
    SPELL_PULSE_GRENAD = 3,
    EVENT_ON_JUSTDIED = 11
};
...
struct npc_pulse_grenade_124928 : public ScriptedAI
{
    ...
    void MoveInLineOfSight(Unit* who) override
    {
        ...
        {
            IsLock = true;
            EventMap().ScheduleEvent(SPELL_PULSE_GRENADE_DMG, 1s);
        }
    }
    bool IsLock;
};
...
struct npc_shrapnel_blast_124776 : public ScriptedAI
{
    ...
    void MoveInLineOfSight(Unit* who) override
    {
        ...
        {
            IsLock = true;
            EventMap().ScheduleEvent(SPELL_SHRAPNEL_BLAST_DMG2, 1s);
        }
    }
    bool IsLock;
};
