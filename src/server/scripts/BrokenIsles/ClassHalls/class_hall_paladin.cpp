...
//250364/broken-sword
class go_broken_sword_250364 : public PlayerScript
{
public:
    go_broken_sword_250364() : PlayerScript("go_broken_sword_250364") { }
    ...
    void OnSpellClick(Unit* clicker, bool& /*result*/)
    {
        if (Player* player = clicker->ToPlayer())
        {
            if (player->GetQuestStatus(QUEST_SHRINE_OF_THE_TRUTHGUARD) == QUEST_STATUS_INCOMPLETE)
            {
                ...
                player->TeleportTo(1495, 4762.8178f, 62.2226f, -0.83612f, true);
            }
        }
    }
};
