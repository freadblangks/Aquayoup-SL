...
class npc_40618_artifact : public PlayerScript
{
public:
    npc_40618_artifact() : PlayerScript("npc_40618_artifact") { }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        if (player->hasQuest(40618) &&
            ...
            AddGossipItemFor(player, GossipOptionIcon::None, "I would like to review weapons we might pursue.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
        }
