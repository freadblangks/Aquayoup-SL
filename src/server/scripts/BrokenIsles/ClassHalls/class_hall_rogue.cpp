...
/// 251033
class go_facade_251033 : public PlayerScript
{
public:
    go_facade_251033() : PlayerScript("go_facade_251033") { }
...
/// 246387
class go_torch_246387 : public PlayerScript
{
public:
    go_torch_246387() : PlayerScript("go_torch_246387") { }
...
/// 246670 chair
class go_chair_246670 : public PlayerScript
{
public:
    go_chair_246670() : PlayerScript("go_chair_246670") { }

    bool OnGossipHello(Player* player, GameObject* go)
    {
        if (player->hasQuest(QUEST_THE_FINAL_SHADOW) && (!player->IsQuestObjectiveProgressBarComplete(QUEST_THE_FINAL_SHADOW, 0)))
        {
        ...
        else if (player->hasQuest(QUEST_THE_FINAL_SHADOW) && (player->IsQuestObjectiveProgressBarComplete(QUEST_THE_FINAL_SHADOW, 0)))
        {
