...
class go_mardum_control_console : public PlayerScript
{
public:
    go_mardum_control_console() : PlayerScript("go_mardum_control_console") { }
...
class npc_mardum_battlelord_gaardoun_103025 : public PlayerScript
{
public:
    npc_mardum_battlelord_gaardoun_103025() : PlayerScript("npc_mardum_battlelord_gaardoun_103025") { }
...
class go_mardum_empowered_nether_crusible : public PlayerScript
{
public:
    go_mardum_empowered_nether_crusible() : PlayerScript("go_mardum_empowered_nether_crusible") { }
     ...
     void OnUpdate(Player* player, uint32 diff)
    {
        if (checkTimer <= diff)
        {
                ...
                !_sceneStarted)
            {
                ...
                player->PlayConversation(6801); // update sql file
            }
            checkTimer = 200;
        }
        else checkTimer -= diff;
