    ...
    public:
        ...
        struct boss_advisor_melandrus_AI : public BossAI
        {
            ...
            void EnterCombat(Unit* )
            {
                Talk(SAY_AGGRO);
                EnterCombat(me);
                EventMap().ScheduleEvent(EVENT_SLICING_MAELSTROM, Seconds(11));
                EventMap().ScheduleEvent(EVENT_PIERCING_GALE, Seconds(6));
                EventMap().ScheduleEvent(EVENT_ENVELOPING_WINDS, Seconds(14));
            }
