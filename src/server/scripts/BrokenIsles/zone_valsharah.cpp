...
class npc_malfurion_valshara : public PlayerScript
{
public:
    npc_malfurion_valshara() : PlayerScript("npc_malfurion_valshara") { }

    bool OnGossipHello(Player* player, Creature* creature)
    {
        AddGossipItemFor(player, GossipOptionIcon::None, "I am ready to aid you, Malfurion.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
// 92742 Ysera
class npc_ysera_valshara : public PlayerScript
{
public:
    npc_ysera_valshara() : PlayerScript("npc_ysera_valshara") { }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        AddGossipItemFor(player, GossipOptionIcon::None, "I am ready, Ysera. Let us find Malfurion!", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
...
class npc_subdued_nightwing : public PlayerScript
{
public:
    npc_subdued_nightwing() : PlayerScript("npc_subdued_nightwing") { }
