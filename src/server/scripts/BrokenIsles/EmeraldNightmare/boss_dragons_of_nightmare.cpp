...
{
    SPELL_BERSERK = 26662,
    SPELL_CORRUPTED_BREATH = 203028,//all
    ...
    SPELL_SIPHON_SPIRIT = 203888,// mythic //When Lethon reaches 100 Energy, approximately every 50 seconds, he will cast
    //summon
    ...
    //When Taerar reaches 100 Energy, approximately every 50 seconds, he will summon
    //SUMMON
...
struct npc_taerar_102681 : public ScriptedAI
{
    ...
    {
        Talk(0);
        EventMap().ScheduleEvent(SPELL_CORRUPTED_BREATH, 33s);
        EventMap().ScheduleEvent(SPELL_MARK_OF_TAERAR, 5s);
        EventMap().ScheduleEvent(SPELL_BELLOWING_ROAR, 15s);
        EventMap().ScheduleEvent(SPELL_SHADES_OF_TAERAR, 50s);
    }
...
struct npc_lethon_102682 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*victim*/)
    {
        Talk(0);
        EventMap().ScheduleEvent(SPELL_CORRUPTED_BREATH, 33s);
        EventMap().ScheduleEvent(SPELL_MARK_OF_LETHON, 5s);
        EventMap().ScheduleEvent(SPELL_LETHON, 10s);
        EventMap().ScheduleEvent(SPELL_SHADOW_BURST, 10s);
        EventMap().ScheduleEvent(SPELL_SIPHON_SPIRIT, 30s);
    }
...
struct npc_emeriss_102683 : public ScriptedAI
{
    ...
    {
        EventMap().ScheduleEvent(SPELL_CORRUPTED_BREATH, 33s);
        EventMap().ScheduleEvent(SPELL_MARK_OF_EMERISS, 5s);
        EventMap().ScheduleEvent(SPELL_VOLATILE_INFECTION, 20s);
        EventMap().ScheduleEvent(SPELL_ESSENCE_OF_CORRUPTION, 30s);
    }
...
struct npc_dread_horror_103044 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*victim*/)
    {
        EventMap().ScheduleEvent(SPELL_WASTING_DREAD, 1s);
        EventMap().ScheduleEvent(1, 20s);
    }
...
struct npc_defiled_druid_spirit_103080 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*victim*/)
    {
        EventMap().ScheduleEvent(SPELL_DEFILED_VINES, 1s);
        EventMap().ScheduleEvent(SPELL_DEFILED_ERUPTION, 5s);
    }
...
struct npc_essence_of_corruption_103691 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*victim*/)
    {
        EventMap().ScheduleEvent(SPELL_CORRUPTION, 5s);
    }
...
struct npc_spirit_shade_103100 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*victim*/)
    {
        EventMap().ScheduleEvent(SPELL_DARK_OFFERING, 5s);
    }
...
struct npc_shade_of_taerar_103145 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*victim*/)
    {
        EventMap().ScheduleEvent(SPELL_CORRUPTED_BREATH, 18s);
    }
...
struct npc_seeping_fog_103697 : public ScriptedAI
{
    ...
    void EnterCombat(Unit* /*victim*/)
    {
        EventMap().ScheduleEvent(SPELL_SEEPING_FOG, 5s);
    }
