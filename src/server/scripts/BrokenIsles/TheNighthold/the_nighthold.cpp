...
public:
    ...
    struct npc_torm_the_bruteAI : public ScriptedAI
    {
        ...
        {
            EventMap().SetPhase(1);
            EventMap().ScheduleEvent(EVENT_TORM_CRASH_DOOR, urand(10000, 25000), 0, 1);
        }

        void EnterCombat(Unit* /*who*/)
        {
            EventMap().SetPhase(2);
            EventMap().ScheduleEvent(EVENT_DEVASTATING_STRIKE, 6000);
            EventMap().ScheduleEvent(EVENT_BOULDER_STRIKE, 13000);
            EventMap().ScheduleEvent(EVENT_RUMBLING_BLOW, 17000);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = EventMap().ExecuteEvent())
            {
                ...
                case EVENT_TORM_CRASH_DOOR:
                    ...
                    EventMap().ScheduleEvent(EVENT_TORM_CRASH_DOOR, urand(5000, 15000), 0, 1);
                    break;
                case EVENT_DEVASTATING_STRIKE:
                    DoCastVictim(SPELL_DEVASTATING_STRIKE);
                    EventMap().ScheduleEvent(EVENT_DEVASTATING_STRIKE, 22000);
                    break;
                case EVENT_BOULDER_STRIKE:
                    ...
                    EventMap().ScheduleEvent(EVENT_BOULDER_STRIKE, 11000);
                    break;
                case EVENT_RUMBLING_BLOW:
                    DoCastSelf(SPELL_RUMBLING_BLOW);
                    EventMap().ScheduleEvent(EVENT_RUMBLING_BLOW, 18000);
                    break;
                default:
                    break;
                }
...
public:
    ...
    struct npc_fulminantAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/)
        {
            EventMap().ScheduleEvent(EVENT_SCATTER, 10000);
            EventMap().ScheduleEvent(EVENT_FULMINATE, 25000);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (me->GetPower(POWER_ENERGY) == 100 && EventMap().GetPhaseMask() == 1)
            ...
            while (uint32 eventId = EventMap().ExecuteEvent())
            {
                ...
                case EVENT_SCATTER:
                    ...
                    EventMap().ScheduleEvent(EVENT_SCATTER, 6000);
                    break;
...
public:
    ...
    struct npc_pulsauronAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/)
        {
            me->GetMotionMaster()->MoveRotate(180000, urand(0, 1), nullptr ? ROTATE_DIRECTION_LEFT : ROTATE_DIRECTION_RIGHT);
            EventMap().ScheduleEvent(EVENT_PULSAURON_BEAM, 5000);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = EventMap().ExecuteEvent())
            {
                ...
                case EVENT_PULSAURON_BEAM:
                    ...
                    EventMap().ScheduleEvent(EVENT_PULSAURON_BEAM, urand(15000, 30000));
                    break;
                default:
                    break;
                }
...
public:
    ...
    struct npc_chaotoidAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/)
        {
            EventMap().ScheduleEvent(EVENT_RELEASE_THE_VOID, urand(10000, 20000));
            EventMap().ScheduleEvent(EVENT_COMPRESS_THE_VOID_GRIP, urand(15000, 25000));
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = EventMap().ExecuteEvent())
            {
                ...
                case EVENT_RELEASE_THE_VOID:
                    ...
                    EventMap().ScheduleEvent(EVENT_RELEASE_THE_VOID, urand(15000, 25000));
                    break;
                case EVENT_COMPRESS_THE_VOID_GRIP:
                    DoCastSelf(SPELL_COMPRESS_THE_VOID_GRIP);
                    EventMap().ScheduleEvent(EVENT_COMPRESS_THE_VOID_GRIP, urand(20000, 35000));
                    break;
                default:
                    break;
                }
