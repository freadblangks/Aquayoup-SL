...
class npc_kayn_sunfury_welcome : public PlayerScript
{
public:
    npc_kayn_sunfury_welcome() : PlayerScript("npc_kayn_sunfury_welcome") { }
...
// 93127 - Kayn Sunfury
class npc_kayn_sunfury : public PlayerScript
{
public:
    npc_kayn_sunfury() : PlayerScript("npc_kayn_sunfury") { }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        {
            AddGossipItemFor(player, GossipOptionIcon::None, "Kayn, I'll show you what I've learned about demonic mysteries.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
...
// 96652
class npc_mannethrel : public PlayerScript
{
public:
    npc_mannethrel() : PlayerScript("npc_mannethrel") { }
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        if (player->GetQuestStatus(QUEST_CRY_HAVOC) == QUEST_STATUS_INCOMPLETE)
        {
            AddGossipItemFor(player, GossipOptionIcon::None, "Get Ready, Mannethrel. I'm going to fill you with the power of the Legion's secrets.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
            SendGossipMenuFor(player, player->GetGossipTextId(creature), creature->GetGUID());
        }
...
// 97303
class npc_mardum_kayn_sunfury_end : public PlayerScript
{
public:
