...
class npc_96675 : public PlayerScript
{
public:
    npc_96675() : PlayerScript("npc_96675") {}
...
class go_244455 : public PlayerScript
{
public:
    go_244455() : PlayerScript("go_244455") { }
...
class npc_97644 : public PlayerScript
{
public:
    npc_97644() : PlayerScript("npc_97644") {}
...
class npc_92718 : public PlayerScript
{
public:
    npc_92718() : PlayerScript("npc_92718") { }
...
// gob 244923 (lever)
class go_244923 : public PlayerScript
{
public:
    go_244923() : PlayerScript("go_244923") { }

    bool OnQuestReward(Player* player, GameObject* go, Quest const* quest, uint32)
    {
        if (quest->GetQuestId() == 38672)
        {
...
class go_244582 : public PlayerScript
{
public:
    go_244582() : PlayerScript("go_244582") { }
...
class go_244588 : public PlayerScript
{
public:
    go_244588() : PlayerScript("go_244588") { }
...
class npc_97978 : public PlayerScript
{
public:
    npc_97978() : PlayerScript("npc_97978") { }
    enum eKhadgar
    {
