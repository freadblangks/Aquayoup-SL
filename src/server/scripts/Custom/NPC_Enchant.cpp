/*
	Npc Enchanting for Trinitycore
	Code: Unknown
	Updated: by Nekro
	July 2020
...
public:
	...
	struct NPC_EnchantAI : public ScriptedAI
    {
		NPC_EnchantAI(Creature* creature) : ScriptedAI(creature) { }
		...
		bool OnGossipHello(Player* player) override
		{
			...
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-Head:30|t Enchant Head", GOSSIP_SENDER_MAIN, 4);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-Shoulder:30|t Enchant Shoulders", GOSSIP_SENDER_MAIN, 5);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-Chest:30|t Enchant Cloak", GOSSIP_SENDER_MAIN, 6);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-Chest:30|t Enchant Chest", GOSSIP_SENDER_MAIN, 7);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-Wrists:30|t Enchant Bracers", GOSSIP_SENDER_MAIN, 8);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-Head:30|t Enchant Gloves", GOSSIP_SENDER_MAIN, 9);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-Waist:30|t Enchant Legs", GOSSIP_SENDER_MAIN, 10);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-Feet:30|t Enchant Feet", GOSSIP_SENDER_MAIN, 11);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-MainHand:30|t Enchant Weapon", GOSSIP_SENDER_MAIN, 1);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-SecondaryHand:30|t Enchant Off-Hand Weapon", GOSSIP_SENDER_MAIN, 13);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-MainHand:30|t Enchant Two-Hand Weapon", GOSSIP_SENDER_MAIN, 2);
			AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-SecondaryHand:30|t Enchant Shield", GOSSIP_SENDER_MAIN, 3);
			
		
			if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) == 450)
			{
				AddGossipItemFor(player, 1, "|TInterface/PaperDoll/UI-PaperDoll-Slot-Finger:30|t Enchant Rings", GOSSIP_SENDER_MAIN, 12);
			}
			AddGossipItemFor(player, 1, "|TInterface\\icons\\spell_holy_fanaticism:30|t I wish to remove my enchant", GOSSIP_SENDER_MAIN, 14);
			AddGossipItemFor(player, 4, "|TInterface\\icons\\spell_chargenegative:30|t Nevermind", GOSSIP_SENDER_MAIN, 15);
		...
		bool OnGossipSelect(Player* player, uint32 /*sender*/, uint32 gossipListId) override
		{
			...
			case 4: // Enchant Head
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100005, me->GetGUID());
				return true;
				break;
			...
			case 5: // Enchant Shoulders
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100006, me->GetGUID());
				return true;
				break;
			...
			case 6: // Enchant Cloak
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100007, me->GetGUID());
				return true;
				break;
			...
			case 7: //Enchant chest
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100008, me->GetGUID());
				return true;
				break;
			...
			case 8: //Enchant Bracers
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100009, me->GetGUID());
				return true;
				break;
			...
			case 9: //Enchant Gloves
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100010, me->GetGUID());
				return true;
				break;
			...
			case 10: //Enchant legs
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100011, me->GetGUID());
				return true;
				break;
			...
			case 11: //Enchant feet
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100012, me->GetGUID());
				return true;
				break;
			...
			case 12: //Enchant rings
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100013, me->GetGUID());
				return true;
				break;
			...
			case 14: //Remove enchant menu
				...
				AddGossipItemFor(player, 1, "<-Back", GOSSIP_SENDER_MAIN, 300);
				SendGossipMenuFor(player, 100014, me->GetGUID());
				return true;
				break;
    ...
    {
        return new NPC_EnchantAI(creature);
    }
