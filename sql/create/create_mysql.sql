...
CREATE DATABASE `freedom` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
GRANT ALL PRIVILEGES ON `freedom` . * TO 'trinity'@'localhost' WITH GRANT OPTION;
