...
INSERT INTO `creature` (`guid`, `id`, `map`, `zoneId`, `areaId`, `spawnDifficulties`, `PhaseId`, `PhaseGroup`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `wander_distance`, `currentwaypoint`, `curhealth`, `curmana`, `MovementType`, `npcflag`, `unit_flags`, `unit_flags3`,  `dynamicflags`, `VerifiedBuild`) VALUES
(@CGUID+0, 88797, 1220, 7334, 7352, '0', 4332, 0, 0, 1, 201.0520782470703125, 6424.34716796875, -22.1320743560791015, 3.902812719345092773, 120, 0, 0, 3138, 3801, 0, 16777216, 0, 512, 0, 46455), -- Elder Aldryth (Area: El'dranil Shallows - Difficulty: 0)
(@CGUID+1, 88797, 1220, 7334, 7355, '0', 4331, 0, 0, 1, -15.3784723281860351, 6738.9599609375, 55.67095184326171875, 5.669478893280029296, 120, 0, 0, 3138, 3801, 0, 0, 0, 0, 0, 46455); -- Elder Aldryth (Area: Crumbled Palace - Difficulty: 0)

DELETE FROM `creature_addon` WHERE `guid` = @CGUID+0;
INSERT INTO `creature_addon` (`guid`, `path_id`, `mount`, `bytes1`, `bytes2`, `emote`, `aiAnimKit`, `movementAnimKit`, `meleeAnimKit`, `visibilityDistanceType`, `auras`) VALUES
(@CGUID+0, 0, 0, 0, 1, 0, 7624, 0, 0, 0, ''); -- Elder Aldryth

UPDATE `creature_template` SET `minlevel`=45, `maxlevel`=45, `VerifiedBuild`=46455 WHERE `entry` = 88797;  -- Elder Aldryth
