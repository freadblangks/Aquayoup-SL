-- Lanthan Perilon (Area: Sunstrider Isle - Difficulty: 0)
UPDATE `creature_template` SET `minlevel`=20, `maxlevel`=20, `VerifiedBuild`=40120 WHERE `entry`=15281;

UPDATE `creature_template_model` SET `VerifiedBuild`=40120 WHERE `CreatureID`=15281 AND `Idx`=0;

UPDATE `creature_model_info` SET `VerifiedBuild`=40120 WHERE `DisplayID`=15515;

DELETE FROM `gossip_menu` WHERE `MenuId`=6570 AND `TextId`=7868;
INSERT INTO `gossip_menu` (`MenuId`, `TextId`, `VerifiedBuild`) VALUES
(6570, 7868, 40120); -- 15281 (Lanthan Perilon)

UPDATE `gossip_menu` SET `VerifiedBuild`=40120 WHERE `MenuId`=6570 AND `TextId`=7869;

UPDATE `npc_text` SET `VerifiedBuild`=40120 WHERE `ID` IN (7868,7869);

UPDATE `creature` SET `zoneId`=6455, `areaId`=3431, `curhealth`=522, `curmana`=1202, `VerifiedBuild`=40120 WHERE `guid`=54987;
