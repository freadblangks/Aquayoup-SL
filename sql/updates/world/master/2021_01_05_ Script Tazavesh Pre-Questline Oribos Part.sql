...
(10565, 17339, 'Oribos - Cosmetic: Al´dalil init. if Quest 63976 is complete');
...
(178908, 0, 0, 0, 10, 0, 100, 0, 1, 10, 20000, 20000, 0, '', 143, 17009, 0, 0, 0, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0, 'Al´dalil - On Quest reward 63976 - Start Conversation 17011 - To Invoker'),
